...
//			for (int i = 0; i < 5; i++) {
//				Textures.LOGISTICS_REQUEST_TABLE[i] = ((TextureMap) par1IIconRegister).registerSprite(new Identifier("logisticspipes:blocks/requesttable/" + i));
//			}
//			Textures.LOGISTICS_REQUEST_TABLE_NEW = ((TextureMap) par1IIconRegister).registerSprite(new Identifier("logisticspipes:blocks/requesttable/requesttexture"));
//			Textures.LOGISTICS_REQUEST_TABLE_NEW_ROUTED = ((TextureMap) par1IIconRegister).registerSprite(new Identifier("logisticspipes:blocks/requesttable/routed"));
//			Textures.LOGISTICS_REQUEST_TABLE_NEW_UNROUTED = ((TextureMap) par1IIconRegister).registerSprite(new Identifier("logisticspipes:blocks/requesttable/unrouted"));
//			Textures.LOGISTICS_REQUEST_TABLE_NEW_EMPTY = ((TextureMap) par1IIconRegister).registerSprite(new Identifier("logisticspipes:blocks/empty"));
//			Textures.LOGISTICS_SIDE_SELECTION = ((TextureMap) par1IIconRegister).registerSprite(new Identifier("logisticspipes:blocks/sideSelection"));
//		}
//
