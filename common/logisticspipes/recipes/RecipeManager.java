...
public class RecipeManager {
	...
	public static void loadRecipes(ICraftingParts parts) {
		...
		if(!Configs.ENABLE_BETA_RECIPES)
		{
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ACTIVE_SUPPLIER), CraftingDependency.Modular_Pipes, new Object[] {
				" G ",
				"rBr",
				Character.valueOf('G'), parts.getGearTear2(),
				Character.valueOf('r'), Items.redstone,
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER), CraftingDependency.Modular_Pipes, new Object[] {
				"rGR",
				" B ",
				"G r",
			...
			craftingManager.addShapelessRecipe(new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER_MK2), CraftingDependency.Modular_Pipes, new Object[] {
			...
			craftingManager.addShapelessRecipe(new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER_MK3), CraftingDependency.Modular_Pipes, new Object[] {
		...
		if(Configs.ENABLE_BETA_RECIPES)
		{
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsPipeComponents, 1, ItemPipeComponents.ITEM_PIPESTRUCTURE),  CraftingDependency.Basic, new Object[] {
				"I I",
				"   ",
				"I I",
				Character.valueOf('I'), Items.iron_ingot
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsPipeComponents, 8, ItemPipeComponents.ITEM_MICROSERVO),  CraftingDependency.Basic, new Object[] {
				"IrI",
				"rIr",
				"IrI",
				Character.valueOf('I'), Items.iron_ingot,
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsPipeComponents, 8, ItemPipeComponents.ITEM_MICROPACKAGER),  CraftingDependency.Basic, new Object[] {
				"rPr",
				"I I",
				"IrI",
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsPipeComponents, 8, ItemPipeComponents.ITEM_MICROCAPSULATOR),  CraftingDependency.Basic, new Object[] {
				"rPr",
				"IGI",
				"IrI",
				Character.valueOf('P'), new ItemStack(Blocks.sticky_piston, 1),
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsPipeComponents, 1, ItemPipeComponents.ITEM_ROUTEPROCESSOR),  CraftingDependency.Basic, new Object[] {
				"nrn",
				"rDr",
				"nrn",
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsPipeComponents, 2, ItemPipeComponents.ITEM_LOGICEXPANDER),  CraftingDependency.Basic, new Object[] {
				"nrn",
				"rIr",
				"nrn",
				Character.valueOf('n'), Items.gold_nugget,
			...
			craftingManager.addShapelessRecipe(new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ACTIVE_SUPPLIER), CraftingDependency.Modular_Pipes, new Object[] {
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, LogisticsSolidBlock.SOLDERING_STATION), CraftingDependency.Basic, new Object[] {
				"iCi",
				"i i",
				"iri",
				Character.valueOf('C'), new ItemStack(Blocks.crafting_table, 1),
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, LogisticsSolidBlock.LOGISTICS_POWER_JUNCTION), CraftingDependency.Basic, new Object[] {
				"iii",
				"rRr",
				"iii",
				Character.valueOf('R'), Blocks.redstone_block,
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, LogisticsSolidBlock.LOGISTICS_SECURITY_STATION), CraftingDependency.Security, new Object[] {
				"iDi",
				"rBr",
				"iii",
				Character.valueOf('D'), logproc,
			...
			craftingManager.addRecipe(new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, LogisticsSolidBlock.LOGISTICS_AUTOCRAFTING_TABLE), CraftingDependency.Basic, new Object[] { 
				"wCw", 
				" G ", 
				"wSw", 
				Character.valueOf('w'), "plankWood",
