...
public class GuiLiquidBasic extends KraphtBaseGuiScreen {

	public GuiLiquidBasic(EntityPlayer player, IInventory inventory) {
		super(180, 130, 0, 0);
		DummyContainer dummy = new DummyContainer(player.inventory, inventory);
		dummy.addLiquidSlot(0, inventory, 28, 13);
	...
	@Override
	public int getGuiID() {
		return GuiIDs.GUI_Liquid_Basic_ID;
	}
