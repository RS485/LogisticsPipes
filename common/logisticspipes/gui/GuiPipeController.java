...
public class GuiPipeController extends LogisticsBaseGuiScreen {
	...
	public void initGui() {
		...
		if (_itemDisplay_5 == null) {
			_itemDisplay_5 = new ItemDisplay(null, mc.fontRendererObj, this, null, 10, 40, 20, 60, new int[] { 1, 1, 1, 1 }, true);
		}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		mc.fontRendererObj.drawString(StringUtils.translate(PREFIX + "inventory"), 10, 122, Color.getValue(Color.DARKER_GREY), false);
		if (current_Tab == 0) {
			mc.fontRendererObj.drawString(StringUtils.translate(PREFIX + "upgrade"), 10, 28, Color.getValue(Color.DARKER_GREY), false);
			if (pipe.getOriginalUpgradeManager().hasCombinedSneakyUpgrade()) {
				mc.fontRendererObj.drawString(StringUtils.translate(PREFIX + "sneakyUpgrades"), 10, 64, Color.getValue(Color.DARKER_GREY), false);
			}
		} else if (current_Tab == 1) {
			mc.fontRendererObj.drawString(StringUtils.translate(PREFIX + "security"), 10, 28, Color.getValue(Color.DARKER_GREY), false);
