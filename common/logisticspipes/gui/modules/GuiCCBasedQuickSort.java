...
public class GuiCCBasedQuickSort extends ModuleBaseGui {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		mc.fontRendererObj.drawString("Timeout Timer", xSize / 2 - mc.fontRendererObj.getStringWidth("Timeout Timer") / 2, 10, 0x404040);
		String timeoutString = Integer.toString(_sortModule.getTimeout()) + " ticks";
		mc.fontRendererObj.drawString(timeoutString, xSize / 2 - mc.fontRendererObj.getStringWidth(timeoutString) / 2, 30, 0x404040);
	}
