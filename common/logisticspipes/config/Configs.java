...
public class Configs {
	...
	private static void readoldconfig() {
		...
		Property logisticModuleIdProperty = CONFIGURATION.get("logisticsModules.id", Configuration.CATEGORY_ITEM, ITEM_MODULE_ID);
		Property logisticItemDiskIdProperty = CONFIGURATION.get("logisticsDisk.id", Configuration.CATEGORY_ITEM, ITEM_DISK_ID);
		Property logisticItemHUDIdProperty = CONFIGURATION.get("logisticsHUD.id", Configuration.CATEGORY_ITEM, ITEM_HUD_ID);
		Property logisticItemPartsIdProperty = CONFIGURATION.get("logisticsHUDParts.id", Configuration.CATEGORY_ITEM, ITEM_PARTS_ID);
		...
		Property logisticItemCardIdProperty = CONFIGURATION.get("logisticItemCard.id", Configuration.CATEGORY_ITEM, ITEM_CARD_ID);
		...
		Property pageDisplayPopupProperty = CONFIGURATION.get("displayPopup", Configuration.CATEGORY_GENERAL, DISPLAY_POPUP);
	...
	public static void load() {
		...
		Property logisticModuleIdProperty = CONFIGURATION.getItem("logisticsModules.id", ITEM_MODULE_ID);
		logisticModuleIdProperty.comment = "The item id for the modules";

		Property logisticUpgradeIdProperty = CONFIGURATION.getItem("logisticsUpgrades.id", ITEM_UPGRADE_ID);
		logisticUpgradeIdProperty.comment = "The item id for the upgrades";

		Property logisticUpgradeManagerIdProperty = CONFIGURATION.getItem("logisticsUpgradeManager.id", ITEM_UPGRADE_MANAGER_ID);
		logisticUpgradeManagerIdProperty.comment = "The item id for the upgrade manager";

		Property logisticItemDiskIdProperty = CONFIGURATION.getItem("logisticsDisk.id", ITEM_DISK_ID);
		logisticItemDiskIdProperty.comment = "The item id for the disk";
		
		Property logisticItemHUDIdProperty = CONFIGURATION.getItem("logisticsHUD.id", ITEM_HUD_ID);
		logisticItemHUDIdProperty.comment = "The item id for the Logistics HUD glasses";

		Property logisticItemPartsIdProperty = CONFIGURATION.getItem("logisticsHUDParts.id", ITEM_PARTS_ID);
		...
		Property logisticItemCardIdProperty = CONFIGURATION.getItem("logisticItemCard.id", ITEM_CARD_ID);
		...
		if(LogisticsPipes.DEBUG) {
			logisticsLiquidContainerIdProperty = CONFIGURATION.getItem("LogisticsLiquidContainer.id", ITEM_LIQUID_CONTAINER_ID);
		...
		Property pageDisplayPopupProperty = CONFIGURATION.get(Configuration.CATEGORY_GENERAL, "displayPopup", DISPLAY_POPUP);
		...
		Property powerUsageMultiplyerPref = CONFIGURATION.get(Configuration.CATEGORY_GENERAL, "powerUsageMultiplyer", POWER_USAGE_MULTIPLIER);
		powerUsageMultiplyerPref.comment = "A Multiplyer for the power usage.";
		
		Property multiThread = CONFIGURATION.get(CATEGORY_MULTITHREAD, "enabled", MULTI_THREAD_ENABLED);
		multiThread.comment = "Enabled the Logistics Pipes multiThread function to allow the network.";
		
		Property multiThreadCount = CONFIGURATION.get(CATEGORY_MULTITHREAD, "count", MULIT_THREAD_NUMBER);
		multiThreadCount.comment = "Number of running Threads.";
		
		Property multiThreadPrio = CONFIGURATION.get(CATEGORY_MULTITHREAD, "priority", MULTI_THREAD_PRIORITY);
		...
		ITEM_UPGRADE_MANAGER_ID				= Integer.parseInt(logisticUpgradeManagerIdProperty.value);
		ITEM_DISK_ID							= Integer.parseInt(logisticItemDiskIdProperty.value);
		ITEM_CARD_ID							= Integer.parseInt(logisticItemCardIdProperty.value);
		ITEM_HUD_ID							= Integer.parseInt(logisticItemHUDIdProperty.value);
		ITEM_PARTS_ID							= Integer.parseInt(logisticItemPartsIdProperty.value);
		...
		//DEBUG (TEST) ONLY
		if(LogisticsPipes.DEBUG) {
			ITEM_LIQUID_CONTAINER_ID				= Integer.parseInt(logisticsLiquidContainerIdProperty.value);
		}
