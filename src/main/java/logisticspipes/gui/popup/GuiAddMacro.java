...
public class GuiAddMacro extends SubGuiScreen implements IItemSearch {
	...
	public void drawScreen(int par1, int par2, float par3){
		...
		fontRendererObj.drawString("Add Macro", guiLeft + fontRendererObj.getStringWidth("Add Macro") / 2, guiTop + 6, 0x404040);
		...
		fontRendererObj.drawString(pageString1, right - 47 - fontRendererObj.getStringWidth(pageString1) / 2 , guiTop + 6 , 0x404040);
		
		
		fontRendererObj.drawString("Macro Items", guiLeft + fontRendererObj.getStringWidth("Add Macro") / 2, guiTop + 136, 0x404040);
		...
		fontRendererObj.drawString(pageString2, right - 47 - fontRendererObj.getStringWidth(pageString2) / 2 , guiTop + 136 , 0x404040);
		
		
		fontRendererObj.drawString("Search:", guiLeft + 8, guiTop + 122, 0x404040);
		...
		fontRendererObj.drawString(Search1 + Search2, guiLeft + 55, guiTop + 122, 0xFFFFFF);
		
		if(editsearch) {
			int linex = guiLeft + 55 + fontRendererObj.getStringWidth(Search1);
		...
		fontRendererObj.drawString("Name:", guiLeft + 8, bottom - 20, 0x404040);
		...
		fontRendererObj.drawString(name1 + name2, guiLeft + 41, bottom - 20, 0xFFFFFF);

		if(editname) {
			int linex = guiLeft + 41 + fontRendererObj.getStringWidth(name1);
			if(System.currentTimeMillis() - oldSystemTime > 500) {
				displaycursor = !displaycursor;
				oldSystemTime = System.currentTimeMillis();
			}
	...
	protected void keyTyped(char c, int i) {
		if(editname) {
			if (c == 13) {
				...
				if (fontRendererObj.getStringWidth(name1 + c + name2) <= nameWidth) {
					name1 += c;
				}
				return;
			} else if(i == 203) { //Left
			...
			if (c == 13) {
				...
				if (fontRendererObj.getStringWidth(Search1 + c + Search2) <= searchWidth) {
					Search1 += c;
				}
				return;
			} else if(i == 203) { //Left
