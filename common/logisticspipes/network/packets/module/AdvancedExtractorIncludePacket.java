...
//TODO				MainProxy.sendPacketToPlayer(new PacketModuleInteger(NetworkConstants.ADVANCED_EXTRACTOR_MODULE_INCLUDED_RESPONSE, getPosX(), getPosY(), getPosZ(), 20, ((ModuleAdvancedExtractor) dummy.getModule()).areItemsIncluded() ? 1 : 0).getPacket(), (Player) player);
					MainProxy.sendPacketToPlayer(PacketHandler.getPacket(AdvancedExtractorInclude.class).setInteger2(((ModuleAdvancedExtractor) dummy.getModule()).areItemsIncluded() ? 1 : 0).setInteger(20).setPosX(getPosX()).setPosY(getPosY()).setPosZ(getPosZ()).getPacket(), (Player) player);
				}
			}
			return;
		}
...
//TODO			MainProxy.sendPacketToPlayer(new PacketModuleInteger(NetworkConstants.ADVANCED_EXTRACTOR_MODULE_INCLUDED_RESPONSE, getPosX(), getPosY(), getPosZ(), -1, module.areItemsIncluded() ? 1 : 0).getPacket(), (Player) player);
				MainProxy.sendPacketToPlayer(PacketHandler.getPacket(AdvancedExtractorInclude.class).setInteger2(module.areItemsIncluded() ? 1 : 0).setInteger(-1).setPosX(getPosX()).setPosY(getPosY()).setPosZ(getPosZ()).getPacket(), (Player) player);
				return;
			}
		} else {
...
//TODO			MainProxy.sendPacketToPlayer(new PacketModuleInteger(NetworkConstants.ADVANCED_EXTRACTOR_MODULE_INCLUDED_RESPONSE, getPosX(), getPosY(), getPosZ(), slot - 1, (module.areItemsIncluded() ? 1 : 0)).getPacket(), (Player) player);
				MainProxy.sendPacketToPlayer(PacketHandler.getPacket(AdvancedExtractorInclude.class).setInteger2((module.areItemsIncluded() ? 1 : 0)).setInteger(slot - 1).setPosX(getPosX()).setPosY(getPosY()).setPosZ(getPosZ()).getPacket(), (Player) player);
				return;
			}
		}
	}
