...
public class MissingMappingHandler {
	...
	private Map<String, String> itemIDMap = ImmutableMap.<String, String>builder()
			...
			.put("item.pipeitemsapiaristsink", "pipe_apiarist_sink")
			.put("item.pipeitemsfirewall", "pipe_firewall")
			.put("item.pipeitemsproviderlogisticsmk2", "pipe_provider_mk2")
			.put("item.pipeitemsapiaristanalyser", "pipe_apiarist_analyzer")
			...
			.put("itemmodule.moduleapiaristterminus", "module_apiarist_terminus")
			.put("itemmodule.moduleapiaristanalyser", "module_apiarist_analyzer")
			.put("itemmodule.moduleelectricmanager", "module_electric_manager")
			...
			.put("itemmodule.moduleelectricbuffer", "module_electric_buffer")
			...
			.put("itemmodule.moduleapiaristsink", "module_apiarist_sink")
			.put("itemmodule.moduleterminus", "module_terminus")
			.put("itemmodule.moduleactivesupplier", "module_active_supplier")
			.put("itemmodule.moduleapiaristrefiller", "module_apiarist_refiller")
