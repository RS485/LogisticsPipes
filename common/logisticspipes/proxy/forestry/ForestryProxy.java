		...
		if(Configs.ENABLE_BETA_RECIPES) {
			...
			if(Configs.MANDATORY_CARPENTER_RECIPES) {
				...
				RecipeManagers.carpenterManager.addRecipe(25, honey, new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.BLANK), new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.APIARISTREFILLER), new Object[] {
					...
					Character.valueOf('C'), propolis,
					Character.valueOf('w'), new ItemStack(LogisticsPipes.LogisticsPipeComponents, 1, ItemPipeComponents.ITEM_MICROCAPSULATOR),
					Character.valueOf('r'), Items.redstone
				});
			...
			if(!Configs.MANDATORY_CARPENTER_RECIPES) {
				...
				manager.addRecipe(new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.APIARISTREFILLER), CraftingDependency.High_Tech_Modules, new Object[] {
					...
					Character.valueOf('p'), pollen,
					Character.valueOf('C'), propolis,
					Character.valueOf('w'), new ItemStack(LogisticsPipes.LogisticsPipeComponents, 1, ItemPipeComponents.ITEM_MICROSERVO),
					Character.valueOf('r'), Items.redstone,
					Character.valueOf('B'), new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.BLANK),
				});
				...
				manager.addRecipe(new ItemStack(LogisticsPipes.LogisticsApiaristAnalyzerPipe, 1, 0), CraftingDependency.High_Tech_Modules, new Object[] { 
					...
					"CrC", 
					Character.valueOf('C'), propolis,
					Character.valueOf('G'), new ItemStack(LogisticsPipes.LogisticsPipeComponents, 1, ItemPipeComponents.ITEM_ROUTEPROCESSOR), 
					Character.valueOf('r'), Items.redstone,
