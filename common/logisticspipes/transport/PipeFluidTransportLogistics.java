...
public class PipeFluidTransportLogistics extends PipeTransportLogistics implements IFluidHandler {
	...
	public FluidTank[] sideTanks = new FluidTank[UtilEnumFacing.VALID_DIRECTIONS.length];
	...
	public int fill(EnumFacing from, FluidStack resource, boolean doFill) {
		if (from.ordinal() < UtilEnumFacing.VALID_DIRECTIONS.length && getFluidPipe().canReceiveFluid()) {
	...
	public FluidStack drain(EnumFacing from, int maxDrain, boolean doDrain) {
		if (from.ordinal() < UtilEnumFacing.VALID_DIRECTIONS.length) {
