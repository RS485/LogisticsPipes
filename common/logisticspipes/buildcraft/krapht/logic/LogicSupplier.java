...
public class LogicSupplier extends BaseRoutingLogic implements IRequireReliableTransport{
	...
	public void onWrenchClicked(EntityPlayer entityplayer) {
		...
		if(MainProxy.isServer()) {
			...
			PacketDispatcher.sendPacketToPlayer(new PacketPipeInteger(NetworkConstants.SUPPLIER_PIPE_MODE_RESPONSE, xCoord, yCoord, zCoord, isRequestingPartials() ? 1 : 0).getPacket(), entityplayer);
		}
	}
