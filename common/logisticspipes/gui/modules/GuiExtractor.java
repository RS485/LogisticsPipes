...
public class GuiExtractor extends ModuleBaseGui {
	...
	private void refreshButtons() {
		for (Object p : buttonList) {
			...
			button.displayString = isExtract(UtilEnumFacing.getOrientation(button.id));
		}
	}

	@Override
	protected void actionPerformed(GuiButton guibutton) {
		_directionReceiver.setSneakyDirection(UtilEnumFacing.getOrientation(guibutton.id));
	...
	private String isExtract(EnumFacing o) {
		String s = (o == UtilEnumFacing.UNKNOWN ? "DEFAULT" : o.name());
