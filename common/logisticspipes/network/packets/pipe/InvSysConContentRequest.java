...
public class InvSysConContentRequest extends CoordinatesPacket {
	...
	public void processPacket(EntityPlayer player) {
		...
		if(pipe.pipe instanceof PipeItemsInvSysConnector) {
			MainProxy.sendPacketToPlayer(PacketHandler.getPacket(InvSysConContent.class).setIdentSet(((PipeItemsInvSysConnector)pipe.pipe).getExpectedItems()).getPacket(), (Player)player);
		}
	}
}
