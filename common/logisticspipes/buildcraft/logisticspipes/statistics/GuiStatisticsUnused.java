package logisticspipes.buildcraft.logisticspipes.statistics;

import java.util.HashMap;
import java.util.LinkedList;

import logisticspipes.buildcraft.krapht.GuiIDs;
import logisticspipes.buildcraft.logisticspipes.modules.IGuiIDHandlerProvider;
...
public class GuiStatisticsUnused extends KraphtBaseGuiScreen {
	...
	public GuiStatisticsUnused(LinkedList<HashMap<ItemIdentifier, Integer>> stats, ItemIdentifier targetItem, GuiScreen previousGui, EntityPlayer player, Pipe pipe) {
		super(250, 200, 0, 0);
