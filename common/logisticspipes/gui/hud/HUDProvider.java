...
public class HUDProvider extends BasicHUDGui {
	...
	public void renderHeadUpDisplay(double distance, boolean day, Minecraft mc, IHUDConfig config) {
		...
		GuiGraphics.renderItemIdentifierStackListIntoGui(pipe.displayList, null, page, -35, -35, 4, 12, 18, 18, mc, DisplayAmount.ALWAYS, true, true);
		GuiGraphics.renderItemIdentifierStackListIntoGui(pipe.itemListOrderer, null, pageB, -35, 25, 4, 4, 18, 18, mc, DisplayAmount.ALWAYS, true, true);
		GL11.glScalef(0.8F, 0.8F, -1F);
