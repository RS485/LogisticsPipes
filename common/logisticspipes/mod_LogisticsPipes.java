...
import logisticspipes.buildcraft.krapht.ActionDisableLogistics;
import logisticspipes.buildcraft.krapht.BuildCraftProxy3;
import logisticspipes.buildcraft.krapht.ILogisticsManager;
import logisticspipes.buildcraft.krapht.LogisticsItem;
import logisticspipes.buildcraft.krapht.LogisticsManager;
import logisticspipes.buildcraft.krapht.LogisticsTriggerProvider;
import logisticspipes.buildcraft.krapht.SimpleServiceLocator;
import logisticspipes.buildcraft.krapht.TriggerSupplierFailed;
...
import logisticspipes.buildcraft.krapht.logistics.LogisticsManagerV2;
import logisticspipes.buildcraft.krapht.network.NetworkConstants;
import logisticspipes.buildcraft.krapht.network.PacketHandler;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsApiaristAnalyser;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsApiaristSink;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsBasicLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsBuilderSupplierLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsCraftingLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsCraftingLogisticsMk2;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsLiquidSupplier;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsProviderLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsProviderLogisticsMk2;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsRemoteOrdererLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsRequestLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsRequestLogisticsMk2;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsSatelliteLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeItemsSupplierLogistics;
import logisticspipes.buildcraft.krapht.pipes.PipeLogisticsChassiMk1;
import logisticspipes.buildcraft.krapht.pipes.PipeLogisticsChassiMk2;
import logisticspipes.buildcraft.krapht.pipes.PipeLogisticsChassiMk3;
import logisticspipes.buildcraft.krapht.pipes.PipeLogisticsChassiMk4;
import logisticspipes.buildcraft.krapht.pipes.PipeLogisticsChassiMk5;
import logisticspipes.buildcraft.krapht.proxy.MainProxy;
import logisticspipes.buildcraft.krapht.recipeproviders.AutoWorkbench;
import logisticspipes.buildcraft.krapht.recipeproviders.RollingMachine;
import logisticspipes.buildcraft.krapht.routing.RouterManager;
import logisticspipes.buildcraft.logisticspipes.ModTextureProxy;
import logisticspipes.buildcraft.logisticspipes.blocks.LogisticsBlock;
import logisticspipes.buildcraft.logisticspipes.blocks.LogisticsBlockRenderer;
import logisticspipes.buildcraft.logisticspipes.blocks.LogisticsTileEntiy;
import logisticspipes.buildcraft.logisticspipes.items.CraftingSignCreator;
import logisticspipes.buildcraft.logisticspipes.items.ItemDisk;
import logisticspipes.buildcraft.logisticspipes.items.ItemModule;
import logisticspipes.buildcraft.logisticspipes.items.RemoteOrdererClientInformation;
...
public class mod_LogisticsPipes extends ModTextureProxy {
	...
	public void PostLoad(FMLPostInitializationEvent event) {
		...
		mod_LogisticsPipes.LogisticsFailedTrigger = new TriggerSupplierFailed(700);
		ActionManager.registerTriggerProvider(new LogisticsTriggerProvider());
		
		mod_LogisticsPipes.LogisticsDisableAction = new ActionDisableLogistics(700);
		...
		*/
		...
		craftingManager.addRecipe(new ItemStack(LogisticsBuilderSupplierPipe, 1), new Object[]{"iPy", Character.valueOf('i'), new ItemStack(Item.dyePowder, 1, 0), Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('y'), new ItemStack(Item.dyePowder, 1,11)});
		...
		craftingManager.addRecipe(new ItemStack(LogisticsLiquidSupplierPipe, 1), new Object[]{" B ", "lPl", " B ", Character.valueOf('l'), new ItemStack(Item.dyePowder, 1, 4), Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('B'), Item.bucketEmpty});
		...
		craftingManager.addRecipe(new ItemStack(LogisticsProviderPipe, 1), new Object[] { "d", "P", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('d'), Item.lightStoneDust});
		craftingManager.addRecipe(new ItemStack(LogisticsCraftingPipe, 1), new Object[] { "dPd", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('d'), Item.lightStoneDust});
		...
		craftingManager.addRecipe(new ItemStack(LogisticsRequestPipe, 1), new Object[] { "gPg", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('g'), BuildCraftCore.goldGearItem});
		craftingManager.addRecipe(new ItemStack(LogisticsRequestPipe, 1), new Object[] { "gPg", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('g'), new ItemStack(BuildCraftSilicon.redstoneChipset, 1, 2)});
		...
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe1, 1), new Object[] { "iii", "iPi", "iii", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), Item.redstone});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe1, 1), new Object[] { " i ","iPi", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), new ItemStack(BuildCraftSilicon.redstoneChipset, 1, 0)});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe2, 1), new Object[] { "iii", "iPi", "iii", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), Item.ingotIron});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe2, 1), new Object[] { " i ","iPi", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), new ItemStack(BuildCraftSilicon.redstoneChipset, 1, 1)});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe3, 1), new Object[] { "iii", "iPi", "iii", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), Item.ingotGold});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe3, 1), new Object[] { " i ","iPi", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), new ItemStack(BuildCraftSilicon.redstoneChipset, 1, 2)});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe4, 1), new Object[] { "iii", "iPi", "iii", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), Item.diamond});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe4, 1), new Object[] { " i ","iPi", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), new ItemStack(BuildCraftSilicon.redstoneChipset, 1, 3)});
		craftingManager.addRecipe(new ItemStack(LogisticsChassiPipe5, 1), new Object[] { "gig", "iPi", "gig", Character.valueOf('P'), mod_LogisticsPipes.LogisticsBasicPipe, Character.valueOf('i'), Block.blockDiamond, Character.valueOf('g'), Block.blockGold});
