...
public class GuiPassiveSupplier extends GuiContainer {
	...
	public GuiPassiveSupplier(IInventory playerInventory, ModulePassiveSupplier supplier, GuiScreen previousGui) {
		super(null);
		_supplier = supplier;
