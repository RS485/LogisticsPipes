...
public final class ItemIdentifier implements Comparable<ItemIdentifier> {
	...
	private static class ItemKey implements Comparable<ItemKey>{
		public ItemKey(Item item, int d){ this.item=item;itemDamage=d;}
		...
		public boolean equals(Object that){
			...
			return item.equals(i.item) && this.itemDamage == i.itemDamage;
		...
		@Override public int hashCode(){
			...
			return ((Item.getIdFromItem(item))*1000001)+itemDamage;
		}
		@Override
