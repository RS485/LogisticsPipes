...
public class GuiPowerProvider extends LogisticsBaseGuiScreen {
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		mc.fontRenderer.drawString(StringUtil.getStringWithSpacesFromInteger(junction.getDisplayPowerLevel()) + " " + junction.getBrand(), guiLeft + 40, guiTop + 35, 0x404040);
		mc.fontRenderer.drawString("/ " + StringUtil.getStringWithSpacesFromInteger(junction.getMaxStorage()) + " " + junction.getBrand(), guiLeft + 40, guiTop + 45, 0x404040);
	}
}
