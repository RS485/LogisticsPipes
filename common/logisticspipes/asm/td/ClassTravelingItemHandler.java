...
public class ClassTravelingItemHandler {
	...
	public static byte[] handleTravelingItemClass(byte[] bytes) {
		...
		if (!"77E58B3B01AF559869F2FCDBD478567E649906B5".equals(sumHandleEvent2) && !"29BF9FE63C7627E88BD6025F2FCED59B8156046C".equals(sumHandleEvent2) && !"780999E7DC3A3FCC579C1ED4802878440693ADB3".equals(sumHandleEvent2)) {
			noChecksumMatch = true;
		}
