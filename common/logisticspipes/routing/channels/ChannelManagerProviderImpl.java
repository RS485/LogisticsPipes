...
public class ChannelManagerProviderImpl implements ChannelManagerProvider {

	public static final ChannelManagerProviderImpl INSTANCE = new ChannelManagerProviderImpl();

	private WeakReference<World> worldWeakReference = null;
	private ChannelManager channelManager = null;

	private ChannelManagerProviderImpl() {
