...
public class FluidGuiOrderer extends GuiOrderer {
	...
	public void initGui() {
		...
		if (setItemDisplay) {
			itemDisplay = new ItemDisplay(this, fontRenderer, this, this, guiLeft + 10, guiTop + 18, xSize - 20, ySize - 100, 0, 0, 0, new int[] { 1, 1000, 16000, 100 }, false);
		}
		itemDisplay.reposition(guiLeft + 10, guiTop + 18, xSize - 20, ySize - 100, 0, 0);
	}
