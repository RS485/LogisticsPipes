...
public class ItemRoutingInformation {
	...
	public void readFromNBT(NBTTagCompound nbttagcompound) {
		if (nbttagcompound.hasKey("destinationUUID")) {
			destinationUUID = FastUUID.parseUUID(nbttagcompound.getString("destinationUUID"));
		}
	...
	public void writeToNBT(NBTTagCompound nbttagcompound) {
		if (destinationUUID != null) {
			nbttagcompound.setString("destinationUUID", FastUUID.toString(destinationUUID));
		}
	...
	public void storeToNBT(NBTTagCompound nbtTagCompound) {
		...
		nbtTagCompound.setString("StoreUUID", FastUUID.toString(uuid));
	...
	public static ItemRoutingInformation restoreFromNBT(NBTTagCompound nbtTagCompound) {
		if (nbtTagCompound.hasKey("StoreUUID")) {
			UUID uuid = FastUUID.parseUUID(nbtTagCompound.getString("StoreUUID"));
