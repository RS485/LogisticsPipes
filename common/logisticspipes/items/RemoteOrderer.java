...
public class RemoteOrderer extends Item {
	...
	public static PipeItemsRemoteOrdererLogistics getPipe(ItemStack stack) {
		...
		if(!stack.stackTagCompound.hasKey("connectedPipe-x") || !stack.stackTagCompound.hasKey("connectedPipe-y") || !stack.stackTagCompound.hasKey("connectedPipe-z")) { return null; }
		if(!stack.stackTagCompound.hasKey("connectedPipe-world-dim")) { return null; }
