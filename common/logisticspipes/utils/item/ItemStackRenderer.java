...
//	private ItemStack itemIdentStack;
//	private int posX;
//	private int posY;
...
//	}
//
//	public static void renderItemStackListIntoGui(List<ItemStack> _allItems, IItemSearch IItemSearch, int page, int left, int top, int columns, int items, int xSize, int ySize, float zLevel, DisplayAmount displayAmount) {
//		ItemStackRenderer.renderItemStackListIntoGui(_allItems, IItemSearch, page, left, top, columns, items, xSize, ySize, zLevel, displayAmount, true, false);
//	}
//
//	public static void renderItemStackListIntoGui(List<ItemStack> _allItems, IItemSearch IItemSearch, int page, int left, int top, int columns, int items, int xSize, int ySize, float zLevel, DisplayAmount displayAmount, boolean renderEffect, boolean ignoreDepth) {
...
//		ItemStackRenderer.renderItemStackListIntoGui(_allItems, IItemSearch, page, left, top, columns, items, xSize, ySize, itemStackRenderer);
//	}
//
//	public static void renderItemStackListIntoGui(List<ItemStack> _allItems, IItemSearch IItemSearch, int page, int left, int top, int columns, int items, int xSize, int ySize, ItemStackRenderer itemStackRenderer) {
//		int ppi = 0;
//		int column = 0;
//		int row = 0;
//
//		for (ItemStack identifierStack : _allItems) {
...
//
//		// set up lightning
//		RenderSystem.scale(1.0F / scaleX, 1.0F / scaleY, 1.0F / scaleZ);
//		RenderHelper.enableGUIStandardItemLighting();
//		OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, 240.0F, 240.0F);
//		RenderSystem.scale(scaleX, scaleY, scaleZ);
//
//		if (ignoreDepth) {
...
//		RenderSystem.translate((float) xPosition, (float) yPosition, 100.0F + renderItem.zLevel);
//		RenderSystem.translate(8.0F, 8.0F, 0.0F);
//		RenderSystem.scale(1.0F, -1.0F, 1.0F);
//		RenderSystem.scale(16.0F, 16.0F, 16.0F);
//
//		if (isGui3d) {
...
//			if (itemstack.isEmpty()) {
//				throw new RuntimeException("No ItemEntity and no ItemStack, I do not know what to render!");
//			} else {
//				if (world == null) {
//					throw new NullPointerException("World object is null");
//				}
//				entityitem = new ItemEntity(world, 0.0D, 0.0D, 0.0D, itemstack);
